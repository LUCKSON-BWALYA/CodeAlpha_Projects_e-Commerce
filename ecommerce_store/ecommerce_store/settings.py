...
SECRET_KEY = 'django-insecure-t=)84*of(^4dya+5lp^748#7u+_o9nyg2^nv7k^l+z*qw19zdr'
...
INSTALLED_APPS = [
    ...
    'ecommerce_store.apps.MongoAdminConfig',
    'ecommerce_store.apps.MongoAuthConfig',
    'ecommerce_store.apps.MongoContentTypesConfig',
